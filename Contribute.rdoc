...
==Run Specs
Testing is currently handled by {Rspec}[http://rspec.info/] and {Jasmine}[http://pivotal.github.io/jasmine/] with headless webkit provided by {PhantomJS}[http://phantomjs.org/]
