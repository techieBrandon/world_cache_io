...
==Install Middleware and WebApp
====Install RVM
Use {RVM}[https://rvm.io/] for ruby version management
  curl -L https://get.rvm.io | bash

===Install Homebrew
Prep your system to pull other dependencies with {Homebrew}[http://brew.sh/]
  cd /usr/local
  mkdir homebrew && curl -L https://github.com/mxcl/homebrew/tarball/master | tar xz --strip 1 -C homebrew

====Install NodeJS and PhantomJS
{PhantomJS}[http://phantomjs.org/] | {NodeJS}[http://nodejs.org/]
  brew update && brew install node phantomjs

====Install Yoeman (Bower & Grunt)
{Yoeman}[http://yeoman.io/] | {Bower}[http://bower.io/] | {Grunt}[http://gruntjs.com/]
...
==Run Specs
Testing is currently handled by {Rspec}[http://rspec.info/] and {Jasmine}[http://pivotal.github.io/jasmine/] with headless webkit provided by {PhantomJS}[http://phantomjs.org/]. Continuous Integration is currently hosted on {Travis-CI}[https://travis-ci.org/] located at https://travis-ci.org/techieBrandon/world_cache_io.
...
==Deploy to EC2
I am currently automating deployment of the entire infrastructure to Amazon's EC2 instances using {Rubber}[https://github.com/rubber/rubber]


This document is written in {RDoc}[http://rdoc.rubyforge.org/RDoc/Markup.html] markup.
